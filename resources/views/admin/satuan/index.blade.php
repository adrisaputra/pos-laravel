									...
									<div class="row">
										...
										<div class="col-xl-4 col-md-12 col-sm-12 col-12">
											<div class="input-group" >
											  <input type="text" name="search" style="height: calc(1.5em + 1.4rem + -8px)" class="form-control" placeholder="Masukkan Nama Satuan" aria-label="Masukkan Nama Satuan" id="search" onkeyup="tampil()">
                            ...
                            <div class="widget-content widget-content-area" style="padding-top: 0px;">
                                ...
                                <div id="hasil">
                                    <div class="table-responsive">
                                        ...
                                        <div class="float-right">{{ $satuan->appends(Request::only('search'))->links() }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
