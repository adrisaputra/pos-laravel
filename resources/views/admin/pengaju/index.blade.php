                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover mb-4">
                                            <thead>
                                                ...
                                                <tbody>
                                                @foreach($pengaju as $v)
                                                    <tr>
                                                        <td>{{ ($pengaju ->currentpage()-1) * $pengaju ->perpage() + $loop->index + 1 }}</td>
                                                        <td>{{ $v->name }}</td>
                                        ...
                                        <div class="float-right">{{ $pengaju->appends(Request::only('search'))->links() }}</div>
                                    </div>
                                </div>
