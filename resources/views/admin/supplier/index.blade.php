									...
									<div class="row">
										...
										<div class="col-xl-4 col-md-12 col-sm-12 col-12">
											<div class="input-group" >
											  <input type="text" name="search" style="height: calc(1.5em + 1.4rem + -8px)" class="form-control" placeholder="Masukkan Nama Supplier" aria-label="Masukkan Nama Supplier" id="search" onkeyup="tampil()">
