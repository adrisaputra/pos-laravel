...
<div class="form-group row mb-4">
    ...
    <div class="col-xl-9 col-lg-9 col-sm-10">
        ...
        @if($pengajuan->ktp)
        <br><a href="{{ asset('upload/sekretariat/ktp/'.$pengajuan->ktp)}}" class="btn btn-sm btn-primary btn-flat" style="background:#1b55e2" target="_blank" > Lihat File</a>
        @endif
...
<div class="form-group row mb-4">
    ...
    <div class="col-xl-9 col-lg-9 col-sm-10">
        ...
        <br><a href="{{ asset('upload/sekretariat/kartu_keluarga/'.$pengajuan->kartu_keluarga)}}" class="btn btn-sm btn-primary btn-flat" style="background:#1b55e2" target="_blank" > Lihat File</a>
        @endif
...
<div class="form-group row mb-4">
    ...
    <div class="col-xl-9 col-lg-9 col-sm-10">
        ...
        <span style="font-size:11px"><i>Ukuran File Tidak Boleh Lebih Dari 3 Mb (jpg,jpeg,png,pdf)</i></span>
        @if($pengajuan->akta_pendirian)
        <br><a href="{{ asset('upload/sekretariat/akta_pendirian/'.$pengajuan->akta_pendirian)}}" class="btn btn-sm btn-primary btn-flat" style="background:#1b55e2" target="_blank" > Lihat File</a>
        @endif
...
<div class="form-group row mb-4">
    ...
    <div class="col-xl-9 col-lg-9 col-sm-10">
        ...
        <span style="font-size:11px"><i>Ukuran File Tidak Boleh Lebih Dari 3 Mb (jpg,jpeg,png,pdf)</i></span>
        @if($pengajuan->surat_keterangan_terdaftar)
        <br><a href="{{ asset('upload/sekretariat/surat_keterangan_terdaftar/'.$pengajuan->surat_keterangan_terdaftar)}}" class="btn btn-sm btn-primary btn-flat" style="background:#1b55e2" target="_blank" > Lihat File</a>
        @endif
...
<div class="form-group row mb-4">
    ...
    <div class="col-xl-9 col-lg-9 col-sm-10">
        ...
        <span style="font-size:11px"><i>Ukuran File Tidak Boleh Lebih Dari 3 Mb (jpg,jpeg,png,pdf)</i></span>
        @if($pengajuan->bukti_lunas_pbb)
        <br><a href="{{ asset('upload/sekretariat/bukti_lunas_pbb/'.$pengajuan->bukti_lunas_pbb)}}" class="btn btn-sm btn-primary btn-flat" style="background:#1b55e2" target="_blank" > Lihat File</a>
        @endif
