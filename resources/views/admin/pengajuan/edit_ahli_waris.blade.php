...
<div class="form-group row mb-4">
    ...
    <div class="col-xl-9 col-lg-9 col-sm-10">
        ...
        @if($pengajuan->skaw)
        <br><a href="{{ asset('upload/ahli_waris/skaw/'.$pengajuan->skaw)}}" class="btn btn-sm btn-primary btn-flat" style="background:#1b55e2" target="_blank" > Lihat File</a>
        @endif
...
<div class="form-group row mb-4">
    ...
    <div class="col-xl-9 col-lg-9 col-sm-10">
        ...
        <br><a href="{{ asset('upload/ahli_waris/akta_kematian/'.$pengajuan->akta_kematian)}}" class="btn btn-sm btn-primary btn-flat" style="background:#1b55e2" target="_blank" > Lihat File</a>
        @endif
...
<div class="form-group row mb-4">
    ...
    <div class="col-xl-9 col-lg-9 col-sm-10">
        ...
        <span style="font-size:11px"><i>Ukuran File Tidak Boleh Lebih Dari 3 Mb (jpg,jpeg,png,pdf)</i></span>
        @if($pengajuan->buku_akta_nikah)
        <br><a href="{{ asset('upload/ahli_waris/buku_akta_nikah/'.$pengajuan->buku_akta_nikah)}}" class="btn btn-sm btn-primary btn-flat" style="background:#1b55e2" target="_blank" > Lihat File</a>
        @endif
...
<div class="form-group row mb-4">
    ...
    <div class="col-xl-9 col-lg-9 col-sm-10">
        ...
        <br><a href="{{ asset('upload/ahli_waris/akta_kelahiran/'.$pengajuan->akta_kelahiran)}}" class="btn btn-sm btn-primary btn-flat" style="background:#1b55e2" target="_blank" > Lihat File</a>
        @endif
...
<div class="form-group row mb-4">
    ...
    <div class="col-xl-9 col-lg-9 col-sm-10">
        ...
        <br><a href="{{ asset('upload/ahli_waris/kartu_keluarga/'.$pengajuan->kartu_keluarga)}}" class="btn btn-sm btn-primary btn-flat" style="background:#1b55e2" target="_blank" > Lihat File</a>
        @endif
...
<div class="form-group row mb-4">
    ...
    <div class="col-xl-9 col-lg-9 col-sm-10">
        ...
        <span style="font-size:11px"><i>Ukuran File Tidak Boleh Lebih Dari 3 Mb (jpg,jpeg,png,pdf)</i></span>
        @if($pengajuan->ktp)
        <br><a href="{{ asset('upload/ahli_waris/ktp/'.$pengajuan->ktp)}}" class="btn btn-sm btn-primary btn-flat" style="background:#1b55e2" target="_blank" > Lihat File</a>
        @endif
...
<div class="form-group row mb-4">
    ...
    <div class="col-xl-9 col-lg-9 col-sm-10">
        ...
        <span style="font-size:11px"><i>Ukuran File Tidak Boleh Lebih Dari 3 Mb (jpg,jpeg,png,pdf)</i></span>
        @if($pengajuan->buku_lunas_pbb)
        <br><a href="{{ asset('upload/ahli_waris/buku_lunas_pbb/'.$pengajuan->buku_lunas_pbb)}}" class="btn btn-sm btn-primary btn-flat" style="background:#1b55e2" target="_blank" > Lihat File</a>
        @endif
