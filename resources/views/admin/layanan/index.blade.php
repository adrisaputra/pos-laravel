									...
									<div class="row">
										...
										<div class="col-xl-4 col-md-12 col-sm-12 col-12">
											<div class="input-group" >
											  <input type="text" name="search" style="height: calc(1.5em + 1.4rem + -8px)" class="form-control" placeholder="Masukkan Nama OPD" aria-label="Masukkan Nama Layanan" id="search" onkeyup="tampil()">
                            ...
                            <div class="widget-content widget-content-area" style="padding-top: 0px;">
                                ...
                                <div id="hasil">
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-hover mb-4">
                                            <thead>
                                                ...
                                                @foreach($layanan as $v)
                                                    <tr>
                                                        <td>{{ ($layanan ->currentpage()-1) * $layanan ->perpage() + $loop->index + 1 }}</td>
                                        ...
                                        <div class="float-right">{{ $layanan->appends(Request::only('search'))->links() }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
